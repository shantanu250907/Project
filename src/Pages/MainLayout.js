...
export default function MainLayout() {
  ...
  return (
    <>
      {/* First Navbar */}
      <Navbar expand="lg" bg="light" variant="light" sticky="top" style={{padding:0}} className=''>
        <Container style={{paddingTop:0,paddingBottom:0}}>
          ...
          <Navbar.Collapse className="justify-content-end">
            <Nav className="align-items-center gap-3">
              ...
              <Button size="sm" as={NavLink} to="/Tenant1" style={{boxShadow:'nnone'}}>Owner</Button>
      ...
      {/* Second Navbar */}
      <Navbar bg="dark" variant="dark" expand="lg"  fixed='stop'>
        <Container>
